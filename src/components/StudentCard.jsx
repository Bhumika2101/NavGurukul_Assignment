...
const StudentCard = ({ student, courseName, onEdit, onDelete }) => {
  return (
    <div
...
/**
 *  NOTE: Performance Optimization with React.memo
 *
 * `React.memo` is a higher-order component that memoizes the rendered output of a component.
 * This means React will skip re-rendering the component if its props have not changed.
 *
 */
